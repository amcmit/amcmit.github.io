      ...
      <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-600 pb-2">
        ...
        {!showForm && (
          <button
            ...
            className="px-3 py-1.5 text-sm font-medium text-white bg-brand-700 rounded-md hover:bg-brand-800"
          >
            + Add Account
          </button>
        )}
        ...
        <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-brand-700 dark:hover:text-brand-300 hover:bg-brand-50 dark:hover:bg-brand-900/30 rounded"
                    title="Edit"
                  >
          ...
          {accounts.length > 0 && (
            <div className="flex justify-between items-center pt-2 border-t border-gray-200 dark:border-gray-600 mt-2">
              ...
              <span className="font-semibold text-gray-900 dark:text-white tabular-nums">{formatCurrency(totalBalance)}</span>
            </div>
          )}
        </div>
      )}
