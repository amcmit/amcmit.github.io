...
export function Layout({
  ...
  return (
    ...
    <div className="no-print min-h-screen bg-[#f7f8fa] dark:bg-[#0f1620] transition-colors duration-200">
      {/* Masthead accent */}
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-baseline gap-2.5">
                <span className="flex items-center justify-center w-8 h-8 rounded-sm bg-brand-700 text-white font-display text-sm font-semibold shrink-0">
                  R
                </span>
                <h1 className="font-display text-[1.7rem] leading-none font-semibold text-gray-900 dark:text-white tracking-tight">
                  Retirement Planner
                </h1>
              </div>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1.5 mb-3">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <div className="flex items-center gap-3.5">
                <div className="flex items-center gap-1.5 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                  <span className="w-2.5 h-2.5 rounded-sm bg-brand-600"></span>
                  <span>Pre-Tax</span>
                </div>
                <div className="flex items-center gap-1.5 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                  <span className="w-2.5 h-2.5 rounded-sm bg-[#1f8a5f]"></span>
                  <span>Roth</span>
                </div>
                <div className="flex items-center gap-1.5 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                  <span className="w-2.5 h-2.5 rounded-sm bg-[#b8862e]"></span>
                  <span>Taxable</span>
                </div>
                <div className="flex items-center gap-1.5 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                  <span className="w-2.5 h-2.5 rounded-sm bg-[#6e5296]"></span>
                  <span>HSA</span>
                </div>
              </div>
